...
public class SwaggerApiGroupBuilder {
    ...
    public List<ResponseMessage> globalResponseMessages_GET() {
        ...
        responseMessages.add(new ResponseMessageBuilder()
                ...
                .build());
        responseMessages.add(new ResponseMessageBuilder()
                .code(ResponseValue.INVALID_OR_MISSING_REQUEST_PARAMETERS.specialCode())
                .message(ResponseValue.INVALID_OR_MISSING_REQUEST_PARAMETERS.message())
                .build());
    ...
    public List<ResponseMessage> globalResponseMessages_POST() {
        ...
        responseMessages.add(new ResponseMessageBuilder()
                ...
                .build());
        responseMessages.add(new ResponseMessageBuilder()
                .code(ResponseValue.INVALID_FIELDS.specialCode())
                .message(ResponseValue.INVALID_FIELDS.message())
                .build());
        return responseMessages;
    }
